...
export class AuditorComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.mypharma.druginventory.Auditor',
      'auditorId': this.auditorId.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceAuditor.updateParticipant(form.get('auditorId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.auditorId) {
        formObject.auditorId = result.auditorId;
      } else {
        formObject.auditorId = null;
      }
